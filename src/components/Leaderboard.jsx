...
//             <img src={user.avatarURL || 'https://www.pngkey.com/png/full/73-730477_first-name-profile-image-placeholder-png.png'} alt={`Avatar of ${user.name}{ width="5px" height="5px"}`} />
